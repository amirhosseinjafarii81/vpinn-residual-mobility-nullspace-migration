...
SCRIPT="${ROOT}/vpinn_gradient_conflict_stage13_fixed_common_blend_pilot.py"
...
STAGE12_SCRIPT="${ROOT}/vpinn_gradient_conflict_stage12_common_pareto_blend_audit.py"
